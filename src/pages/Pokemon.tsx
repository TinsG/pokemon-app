          ...
          <div className="mx-auto space-y-6">
            ...
            {isOpen ?
              <div className="w-full md:w-1/3 justify-items-end ">
                ...
                <button type="submit" onClick={_ => handleAddProduct()} className="text-white my-2 md:mx-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                <button type="submit" onClick={_ => closeCatchForm()} className="text-white my-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cancel</button>
              </div>
              : <></>}
