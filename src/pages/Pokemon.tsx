            ...
            {isOpen ?
              <form onSubmit={handleAddProduct}>
                <div className="w-full md:w-1/3 justify-items-end ">
                  ...
                  <button type="submit" disabled={nickName===''} onClick={_ => handleAddProduct()} className="text-yellow-200 my-2 md:mx-5 bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
